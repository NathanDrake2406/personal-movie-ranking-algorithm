...
describe("normalizeTitle", () => {
  ...
  it("removes punctuation", () => {
    ...
    expect(normalizeTitle("Spider-Man: Homecoming")).toBe(
...
describe("generateVariants", () => {
  it("swaps & to and", () => {
    expect(generateVariants("Pride & Prejudice")).toContain(
      "Pride and Prejudice",
    );
  });

  it("swaps and to &", () => {
    expect(generateVariants("Pride and Prejudice")).toContain(
      "Pride & Prejudice",
    );
  });
  ...
  it("excludes original query from variants", () => {
    expect(generateVariants("Pride & Prejudice")).not.toContain(
      "Pride & Prejudice",
    );
  });
});
